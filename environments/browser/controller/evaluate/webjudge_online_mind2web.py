...
# @evaluate.tool("identify_key_point")
async def identify_key_point(ctx: Context, task_description: dict | str) -> dict:
...
@mcp.tool
async def webjudge_online_mind2web(
    ctx: Context,
    task_description: dict | str
) -> dict:
    ...
    try:
        ...
        key_points_result = await identify_key_point(ctx, task_description)
